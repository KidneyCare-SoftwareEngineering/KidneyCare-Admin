...
const Menu: React.FC = () => {
    ...
    const handleUpdate = async (id: number, additionalData?: { name?: string; image?: string }) => {
        const formData = new FormData();
        formData.append("recipe_name", foodName || additionalData?.name || "");
        ...
        console.log("Form data:", {
            recipe_name: foodName || additionalData?.name || "",
            calories,
